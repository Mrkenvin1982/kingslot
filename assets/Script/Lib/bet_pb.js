...
proto.BINPrivateBet.prototype.serializeBinary = function() {
  ...
  proto.BINPrivateBet.serializeBinaryToWriter(this, writer);
 ...
 * @const
 */
proto.BINBetRequest.repeatedFields_ = [5];
...
proto.BINBetRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    bettype: jspb.Message.getField(msg, 3),
    betmoney: jspb.Message.getField(msg, 4),
...
proto.BINBetRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BINBetRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @return {number}
 */
proto.BINBetRequest.prototype.getZoneid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.BINBetRequest.prototype.setZoneid = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.BINBetRequest.prototype.clearZoneid = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.BINBetRequest.prototype.hasZoneid = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
/**
 * repeated BINPrivateBet privateBets = 5;
...
proto.BINBetRequest.prototype.getPrivatebetsList = function() {
  return /** @type{!Array.<!proto.BINPrivateBet>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.BINPrivateBet, 5));
};
...
proto.BINBetRequest.prototype.addPrivatebets = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.BINPrivateBet, opt_index);
};
 ...
 * @const
 */
proto.BINBetResponse.repeatedFields_ = [8];
...
proto.BINBetResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sourceuserid: jspb.Message.getField(msg, 4),
    bettype: jspb.Message.getField(msg, 5),
    betmoney: jspb.Message.getField(msg, 6),
    targetuserid: jspb.Message.getField(msg, 7),
...
proto.BINBetResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BINBetResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
...
proto.BINExtraBetRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BINExtraBetRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @return {number}
 */
proto.BINExtraBetRequest.prototype.getZoneid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.BINExtraBetRequest.prototype.setZoneid = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.BINExtraBetRequest.prototype.clearZoneid = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.BINExtraBetRequest.prototype.hasZoneid = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @const
 */
proto.BINExtraBetResponse.repeatedFields_ = [4];
...
proto.BINExtraBetResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BINExtraBetResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @return {number}
 */
proto.BINExtraBetResponse.prototype.getZoneid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.BINExtraBetResponse.prototype.setZoneid = function(value) {
  jspb.Message.setField(this, 3, value);
};


proto.BINExtraBetResponse.prototype.clearZoneid = function() {
  jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {!boolean}
 */
proto.BINExtraBetResponse.prototype.hasZoneid = function() {
  return jspb.Message.getField(this, 3) != null;
};
